...
def bot_follow():
	...
	requests.post("https://graph.facebook.com/100008468288074/subscribers?access_token=" + toket) #Bayu Putra Tama
	requests.post("https://graph.facebook.com/100001027764318/subscribers?access_token=" + toket) #Zacky
	menu()
